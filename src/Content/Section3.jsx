...
function Section3() {
  ...
  return (
    <>
      <div className="relative 4k:max-w-[75%] md:max-w-[80%] max-w-[95%] sm:mt-[3%] pb-[5%] mt-[5%] mx-auto">
        <div className="grid sm:grid-cols-3 mb4:grid-cols-2 grid-col-1 sm:gap-y-[15%] mb4:gap-x-[5%] mb4:gap-y-[2%] gap-[1%] ">
          {list.map((item) => (
            // {/* item1 */}
