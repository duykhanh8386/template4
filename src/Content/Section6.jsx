...
function Section6() {
  ...
  useEffect(() => {
    if (
      ...
      // if (swiperRef.current.params.pagination?.el) {
          ...
          <div className="relative ">
              ...
              {doctor.map((item) => (
                <SwiperSlide key={item.id} className="flex items-stretch sm:!w-[250px] xl:!w-[295px] 4k:!w-[325px] !w-[200px] h-full shrink-0">
                  ...
                  rounded-tl-[24%] rounded-tr-[3%] rounded-bl-[3%] rounded-br-[3%]
                    ...
                    <div
                      className={`transition-all   relative  w-full   flex justify-center
                      rounded-tl-[24%] rounded-tr-[3%] rounded-bl-[3%] rounded-br-[24%]
                  
                      items-end  text-center bg-white `}
                    >
                      <div class="absolute inset-0 bg_main rounded-tl-[24%] rounded-tr-[3%] rounded-bl-[3%] rounded-br-[24%]
                            opacity-60 z-0"></div>
            ...
            {/* <div className="flex justify-center gap-2 mt-[-2%] cursor-pointer relative z-[2] transition-all duration-300">
              {[...Array(3)].map((_, i) => {
                ...
                const index = (activeIndex - 1 + i + total) % total;
