...
function Footer(){
  ...
  <div className="relative z-[1] 4k:max-w-[75%] sm:max-w-[80%] max-w-[95%] mx-auto grid lg:grid-cols-13 grid-cols-5 lg:pb-[20px] sm:pb-[5%] pb-[10px] pt-[5%] gap-[5%] xl:gap-[5%]">
    ...
    <div className="lg:col-span-3 col-span-5 grid grid-cols-5 lg:gap-y-3">
      <h3 className="font-medium col-span-3 mt-0.5 text-[14px] block lg:hidden text-white xl:text-xl 4k:text-xl mb-2">Theo dõi chúng tôi</h3>
      <div className="grid grid-cols-5 gap-4 col-span-5 items-center">
        <div className="col-span-3 sm:col-span-4 lg:col-span-5 flex gap-4">
        <a href="#" className="w-10 h-10 border border-white rounded-full flex items-center justify-center">
  ...
  {/* Footer dưới */}
  <div className="border-t border-white/20 mt-[15%] mb4:mt-[5%] md:mt-[3%] py-5 flex items-center justify-center lg:mt-0 text-center text-sm z-1 relative">
